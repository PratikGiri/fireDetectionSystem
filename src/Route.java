...
public class Route {
	...
	public boolean findPoint(Node a, Node[] Source) {
		boolean found = false;
	...
	public Node bfs(Node target, Node[] Start) {
...
//					System.out.println("("+tempi+","+tempj+")"+" "+(Mark[tempi][tempj]-1));
					Node newCor = new Node(tempi,tempj);
	...
	public ArrayList<Node> findRoute(Node Target, Node Start, int[][]Mark) {
